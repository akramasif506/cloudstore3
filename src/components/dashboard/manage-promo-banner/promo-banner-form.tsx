...
import type { PromoBanner } from '@/app/dashboard/manage-promo-banner/actions';
import { updatePromoBanner, clearPromoBanner } from '@/app/dashboard/manage-promo-banner/actions';
